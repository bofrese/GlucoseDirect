...
enum DirectAction {
    ...
    case setAlarmHighSleep(upperLimit: Int)
    case setAlarmLowSleep(lowerLimit: Int)
    ...
    case setEnableSleepMode(enabled: Bool)
    case setBeginSleepTime(beginSleepTime: Date)
    case setEndSleepTime(endSleepTime: Date)
